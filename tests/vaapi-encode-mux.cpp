// translation of ffmpeg's vaapi-encode.c example to libavpp, with muxing
    ...
    const char *const outpath)
{
    ...
    stream.get()->id = writer.get()->nb_streams - 1;
    ...
    stream->time_base = enc.get()->time_base;
    ...
    while (true)
    {
        ...
        {
            pkt->stream_index = stream.get()->index;
            av_packet_rescale_ts(
                pkt, enc.get()->time_base, stream.get()->time_base);
